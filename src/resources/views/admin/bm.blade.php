...
@endfor
    <input type="text" class="tax" id="tax" name="tax" value="{{old("tax")}}"><input type="text" class="value" id="value" name="value" value="value"><input type="text" class="subtotal" id="subtotal" name="subtotal" value="{{old("subtotal")}}"><input type="text" class="ctsv" id="ctsv" name="ctsv" value="{{old("ctsv")}}"><input type="text" class="sum" id="sum" name="sum" value="{{old("sum")}}"><input type="text" class="remarks" id="remarks" name="remarks" value="{{old("remarks")}}">
